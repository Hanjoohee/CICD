...
<body>
    ...
    <div id="rouletteContainer">
        ...
        <button class="roulette-button" id="startButton">시작하기</button>
        <button class="roulette-button" id="stopButton" style="display: none;">멈추기</button>
        <div class="winner-banner" id="winnerBanner"></div>
        <button class="prize-button" id="prizeButton">경품 받기</button>
    </div>
